...
checkRole(['Admin', 'Tender Creator', 'Auditor']); // Only Admin, Tender Creator, and Auditor users can access
...
<div class="users-container">
    <header class="users-header-flex">
        <div>
            <h1>Users List</h1>
            <p style="color: var(--text-muted)">Dashboard / All Users</p>
        </div>
